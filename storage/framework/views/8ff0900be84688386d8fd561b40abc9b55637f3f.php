...
<?php if($controller =='AdminController@dashboard'): ?>
        ...
        <link rel="stylesheet" href="<?php echo e(asset('css/backend_css/colorpicker.css')); ?>"/>
        ...
        <link rel="stylesheet" href="<?php echo e(asset('fonts/backend_fonts/css/font-awesome.css')); ?>"/>
        <link rel="stylesheet" href="<?php echo e(asset('css/backend_css/jquery.gritter.css')); ?>"/>
        <link rel="stylesheet" href="<?php echo e(asset('foundation-icons/foundation-icons.css')); ?>"/>
...
<?php else: ?>
        ...
        <link rel="stylesheet" href="<?php echo e(asset('css/backend_css/bootstrap-responsive.min.css')); ?>" />
        <link rel="stylesheet" href="<?php echo e(asset('css/backend_css/colorpicker.css')); ?>" />
        <link rel="stylesheet" href="<?php echo e(asset('css/backend_css/datepicker.css')); ?>" />
        ...
        <link rel="stylesheet" href="<?php echo e(asset('css/backend_css/font-awesome.css')); ?>" />
        <link rel="stylesheet" href="<?php echo e(asset('fonts/backend_fonts/css/font-awesome.css')); ?>"  />
...
<?php if($controller =='AdminController@dashboard'): ?>
        ...
        <script src="<?php echo e(asset('js/backend_js/bootstrap-datepicker.js')); ?>"></script>
...
<script type="text/javascript">
  ...
  //Message alert----------------------//
    ...
    <?php if(session()->get('fa-error')): ?>
    var message= "<?php echo e(session()->get('fa-error')); ?>"+". you can edit only for this ministry project.Click outside to select Other ministry Project ";
      var element=document.createElement('div');      
      var link=document.createElement('a');
      link.setAttribute('href',"<?php echo e(route('fa-budget-accounts.create')); ?>");
    ...
    <?php if(session()->get('fa-error-edit')): ?>
    var message= "<?php echo e(session()->get('fa-error-edit')); ?>"+" under this ministry. Click outside to Stay on this page..!";
      var element=document.createElement('div');      
      var link=document.createElement('a');
      link.setAttribute('href',"<?php echo e(route('fa-budget-accounts.index')); ?>");
      link.setAttribute('id',"edit-button");  
      link.setAttribute('style',"border-radius:15px;background:#506BB1;color:#fff;padding-x:10px;padding-y:10px;margin-left:10px");
...
<script>
    ...
    function changeLocale(sel)
    {
        ...
        var language = sel;
        $.ajax({
            url:  "<?php echo e(route('change_language')); ?>",
            type: 'post',
            data: { lang: language},
 ...
 function show_m_target(val)
        {
                var goal = val.value;
                $.ajax({
                        url: "<?php echo e(route('get_m_target')); ?>",
                        type: 'get',
                        data: {
                                goal_id: goal,
                        },
        ...
        {
                $.ajax({
                        url: "<?php echo e(route('get_m_goal')); ?>",
                        type: "get",
                        success: function (data)
                        {
                                console.log('success');
...
<script>
    function gender_target(val)
        {
                var goal = val.value;
                $.ajax({
                        url: "<?php echo e(route('get_gender_target')); ?>",
                        type: 'get',
                        data: {
                                goal_id: goal,
                        },
   ...
   function add_gender_row(i)
        ...
        {
                $.ajax({
                        url: "<?php echo e(route('gendergoal')); ?>",
                        type: "get",
                        success: function (data)
                        {
                                console.log('success');
...
<script  type="text/javascript">
        ...
        function showsdgsgoalstargetforcart(val) {
                ...
                rowCount++;
                $.ajax({
                        url: "<?php echo e(route('getting_the_target')); ?>",
                        type: 'get',
                        data: {
                                goal_id: goal,
                        },
        ...
        {
                $.ajax({
                        url: "<?php echo e(route('get_sdgs_goal')); ?>",
                        type: "get",
                        success: function (data)
                        {
                                console.log('success');
...
<script type="text/javascript">
                function  clickcomment(id)
                {
                        // alert(id);
                         $.ajax({
                    url: "<?php echo e(route('showcomment')); ?>",
                    type: 'get',
                ...
                function addcommentonmodal(id)
                {
                        ...
                        $.ajax({
                                url: "<?php echo e(route('send_modal_add_comment_data')); ?>",
                                type: 'get',
                ...
                function showcoment_on_Edit()
                {
                  ...
                  $.ajax({
                  url: "<?php echo e(route('show_comment_data')); ?>",
                   type: 'get',
                    data: {
                     id: id,
                     },
...
<script>
    ...
    function get_cliamate_goal_data (rowCount) {
        $.ajax({
            url: "<?php echo e(route('get_climate_goal')); ?>",
            type: "get",
            success: function (data)
            {
                console.log('success');
    ...
    function climate_target(val) {
        var goal = val.value;
        $.ajax({
            url: "<?php echo e(route('getting_the_climate_target')); ?>",
            type: 'get',
            data: {
                goal_id: goal,
            },
...
<script>
    ...
    function get_poverty_goal_data (rowCount) {
        $.ajax({
            url: "<?php echo e(route('get_poverty_goal')); ?>",
            type: "get",
            success: function (data)
            {
                console.log('success');
    ...
    function poverty_target(val) {
        var goal = val.value;
        $.ajax({
            url: "<?php echo e(route('poverty_target')); ?>",
            type: 'get',
            data: {
                goal_id: goal,
            },
...
<script>
    ...
    function add_row_component(i)
    {
            ...
            else
            {
                    ...
                    $('#component_table').append(
                            '<tr id="tr_' + rowCount + '">'
                            + '<td><input type="text"  name="components_name[]"    class="span11" placeholder=" <?php echo app('translator')->getFromJson("Component Name"); ?>"  /></td>'
                            + '<td><input type="number"  name="quantity[]"         class="span11" placeholder=" <?php echo app('translator')->getFromJson("Quantity"); ?>"  /></td>'
                            + '<td><input type="number"   name="unit_cost[]"       class="span11" placeholder=" <?php echo app('translator')->getFromJson("Unit Cost"); ?>"  /></td>'
                            + '<td><input type="number"   name="estimated_cost[]"  class="span11" placeholder=" <?php echo app('translator')->getFromJson("Estimated Cost"); ?>"  /></td>'
                            + '<td>\n\
                        <a class="btn btn-success" id="add_' + rowCount + '" title="<?php echo app('translator')->getFromJson('Add'); ?>" onclick="add_row_component(' + rowCount + ');"><i class="icon-plus" ></i></a>\n\
                        <a class="btn btn-danger"  title="<?php echo app('translator')->getFromJson('Delete'); ?>"  onclick="remove_row_component(' + rowCount + ');"><i class="icon-minus" ></i> </a>\n\
                    </td>'
                            + '</tr>'
   ...
   {       
           var id= val.value;
           $.ajax({
                   url: "<?php echo e(route('getting_sub_sector')); ?>",
                   type: 'get',
                   data: {
                           id: id,
                   },
   ...
   function subsec_to_ministry(val)
   {
           ...
           var id= val.value;
           $.ajax({
                   url: "<?php echo e(route('getting_ministry')); ?>",
                   type: 'get',
                   data: {
                           id: id,
                   },
   ...
   function sector_to_ministry(val)
   {
           ...
           $.ajax({
                   url: "<?php echo e(url('sector-to-ministry')); ?>",
                   type: 'get',
                   data: {
                           id: id,
                   },
   ...
   function ministry_to_project(val)
   {
        var form_data=$('#upper_data').find("[name]").serialize();
           ...
           $.ajax({
                   url: "<?php echo e(url('ministry-to-project')); ?>",
                   type: 'get',
                   data: form_data,
                   success: function (response) {
...
function ministry_to_project_edit(val)
   {
           ...
           $.ajax({
                   url: "<?php echo e(url('ministry-to-project_edit')); ?>",
                   type: 'get',
                   data: form_data,
