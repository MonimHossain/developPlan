                ...
                <div class="span12">
                    ...
                    <div class="widget-box">
                        <div class="widget-title"> <span class="icon"> <i class="icon-align-justify"></i> </span>
                            <h5>@lang("ADD MULTI-YEAR TARGETS") </h5>
                        </div>
                        <div class="widget-content nopadding">
                            <form action="{{route('multiyear-target.store')}}" method="post" class="form-horizontal">
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <select name="gole_id">
                                            <option value=""> @lang('Select Gole')</option>
                                            @foreach($multiyear_goals as $pppgoles)
                                            <option value="{{$pppgoles->id}}"> {{$pppgoles->gole_name}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="form-actions">
                                    ...
                                    <a href="{{route('multiyear-target.index')}} " class="btn btn-danger">@lang("Close")</a>
                                </div>
                            </form>
                        </div>
                    </div>
