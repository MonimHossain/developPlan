                ...
                <div class="span12">
                    ...
                    <div class="widget-box">
                        ...
                        <div class="widget-content nopadding">
                            <form action="{{route('sdgstargets.store')}}" method="post" class="form-horizontal">
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <select name="gole_id">
                                            ...
                                            <option value="{{$sdgsgoles->id}}"> {{$sdgsgoles->gole_name}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="form-actions">
                                    ...
                                    <a href="{{route('sdgstargets.index')}} " class="btn btn-danger">@lang("Close")</a>
                                </div>
                            </form>
                        </div>
                    </div>
