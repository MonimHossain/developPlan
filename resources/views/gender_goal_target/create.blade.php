                ...
                <div class="span12">
                    ...
                    <div class="widget-box">
                        <div class="widget-title"> <span class="icon"> <i class="icon-align-justify"></i> </span>
                            <h5>@lang("ADD GENDER TARGETS") </h5>
                        </div>
                        <div class="widget-content nopadding">
                            <form action="{{route('genderGoalTarget.store')}}" method="post" class="form-horizontal">
                                ...
                                <div class="form-actions">
                                    ...
                                    <a href="{{route('genderGoalTarget.index')}} " class="btn btn-danger">@lang("Close")</a>
                                </div>
                            </form>
                        </div>
                    </div>
