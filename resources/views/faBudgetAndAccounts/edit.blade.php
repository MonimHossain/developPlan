...
@section('content')
    <div id="content">
        ...
        <div class="container-fluid">
            ...
            <div class="container-fluid">
                <h4 style="text-align:center;text-decoration:underline">@lang('Foreign Aid Budget And Accounts Edit')</h4>
            </div>
            {{-- start upper filed --}}
            ...
            @method('PATCH')
                ...
                <div class="row-fluid form-horizontal" id="upper_data">
                    ...
                    <div class="span12">
                        ...
                        <div class="span5">
                            <div id='loding' style="z-index: 2000"></div>
                           <div class="">
                                <label class="control-label">@lang('Ministry'):</label>
                                                        
                            <div class="controls">
                                <select id="showministry" name="ministry_id" onchange="ministry_to_project_edit(this)">
                    ...
                    <div class="widget-box">
                        ...
                        <div class="widget-content nopadding" id="table-body">
                           ...
                           {{--  <div style="height:30px;width:100%; background:#747474">
                                <div align="center"> --}}
                                    {{-- <button class="btn btn-default" formaction="{{route('fa-budget-accounts.create')}}">@lang('Submit')</button>
                                </div> --}}
                         {{--    </div> --}}
