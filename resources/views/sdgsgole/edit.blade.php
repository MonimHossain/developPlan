                ...
                <div class="span12">
                    ...
                    <div class="widget-box">
                        ...
                        <div class="widget-content nopadding">
                            <form action="{{ route('sdgsgole.update',$show_sdgsgole->id)}}" method="post" class="form-horizontal">
                                @method('PATCH')
                                @csrf
                                ...
                                <div class="form-actions">
                                    ...
                                    <a href="{{route('sdgsgole.index')}}" class="btn btn-danger">@lang("Close Update")</a>
                                </div>
                            </form>
                        </div>
                    </div>
