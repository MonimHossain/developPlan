            ...
            <div class="span12">
                ...
                <div class="widget-box">
                    ...
                    <div class="widget-content nopadding">
                         <form method="get" action="{{route('sendadpallocation.create')}}" class="allocation_form">
            ...
            <hr/>
                        <form action="{{route('sendadpallocation.store')}}" method="post" class="form-horizontal">
                            ...
                            <div class="form-actions pull-right">
                                ...
                                <button type="submit" name="submitbutton" value="send" class="btn btn-success">@lang("Send to ministerial meeting")</button>
                                @else
