    ...
    <div class="container-fluid">
        <div class="quick-actions_homepage">
            <ul class="quick-actions">
                ...
                <li class="bg_lb"> <a href="{{ route('newprojectlist.create') }}"> <i class="icon-dashboard"></i> <span class="label label-important">{{ $newprojectCount }}</span> New Project </a> </li>
                <li class="bg_lg span3"> <a href="charts.html"> <i class="icon-signal"></i> Charts</a> </li>
                <li class="bg_ly"> <a href="{{ route('approaved_project.index') }}"> <i class="icon-inbox"></i><span class="label label-success">{{ $approveprojectCount }}</span> Approve Project </a> </li>
                <li class="bg_lo"> <a href="{{ route('guideline.showguideline') }}"> <i class="icon-th"></i><span class="label label-success">{{ $guidelinelistCount }}</span> Guideline</a> </li>
                <li class="bg_ls"> <a href="{{ route('allocated_project.index') }}"> <i class="icon-fullscreen"></i><span class="label label-success">{{ $demandslistCount }}</span> Allocation </a> </li>
