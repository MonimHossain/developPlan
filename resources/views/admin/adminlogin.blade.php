		...
		<div class="container">
			<div class="row">
				<div class="col-md-5 col-sm-5">
					<!--<img src="{{asset('images/backend_images/login-flow.png')}}">-->
				</div>
				...
				<div class="col-md-5 col-sm-5">
					...
					<form action="{{ url('admin') }}" id="loginform" class="form-signin" role="form" method="post" accept-charset="utf-8"><div style="display:none;"><input type="hidden" name="_method" value="POST"/>
						@csrf
